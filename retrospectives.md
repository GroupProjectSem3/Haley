...
## Project Retrospective Board - Sprint 10

## Liked / Glad

- New interface of the system.
- Post Deployment, API calls are quite fast.
- Cooperation from team 3's deployment team.

## Learned

- Learnt Google Cloud Engine deployment.
- Learnt to be able to manipulate CSS like a pro finally.
- Got an indepth knowledge on the inner workings of Google Maps API and OpenStreet Map API.
- Learnt about GP list usage by the ICGP.

## Lacked / Mad

- Ridiculous number of branches running parallel on the repo.
...
- API keys for the maps need a billing account.
- More educational toys to work with.

## Action Items aka Jugaad
